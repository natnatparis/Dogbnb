...
10.times do
  choice_dogsitter = Dogsitter.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name) 
end

#Boucle permettant d'afficher les "fake" dogsitters (on supprimera le contenur de la BDD après chaque relance de rails db:seed)
10.times do
   choice_dog = Dog.create!(nick_name: Faker::Creature::Dog.name)
end
